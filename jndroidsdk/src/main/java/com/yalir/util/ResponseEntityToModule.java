...
/**
 * @filename：ResponseEntityToModule.java
 * @author：yakir
 * @description：递归ORM映射(有反射，不能被混淆)
 */
public class ResponseEntityToModule {
    ...
    private static RealmList<RealmObject> parseJsonArrayToRealmList(Field field, String fieldName, Object moduleObj, JSONObject jsonObj) throws JSONException, IllegalArgumentException, IllegalAccessException {
