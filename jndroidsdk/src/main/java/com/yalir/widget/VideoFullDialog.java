...
import com.yalir.R;
import com.yalir.activity.AdBrowserActivity;
import com.yalir.constant.SDKConstant;
import com.yalir.core.VideoAdSlot.AdSDKSlotListener;
import com.yalir.module.AdValue;
import com.yalir.report.ReportManager;
import com.yalir.util.LogUtils;
import com.yalir.util.Utils;
import com.yalir.widget.CustomVideoView.ADVideoPlayerListener;
...
public class VideoFullDialog extends Dialog implements ADVideoPlayerListener {
    ...
    public VideoFullDialog(Context context, CustomVideoView mraidView, AdValue instance, int position) {
